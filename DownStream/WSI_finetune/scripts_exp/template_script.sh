...
#     --data_path /data/ssd_1/WSI/${DATASET_NAME}/tiles-embeddings/ \
#     --task_description_csv /data/ssd_1/WSI/${DATASET_NAME}/${DATASET_NAME}_clinical_data.csv \
...
#     --enable_tensorboard \
#     --task_description_csv /data/ssd_1/WSI/${DATASET_NAME}/tiles-embeddings/task-settings-5folds/${CSV_FNAME} \
#     --task_setting_folder_name task-settings-5folds \
